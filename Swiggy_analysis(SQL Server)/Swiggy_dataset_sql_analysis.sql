...
-------------------------------------------------------------
--Insights:
--we  sorted the ratings in decesnding order to find out the city with higest number of resturants
...
----------------------------------------------------------------
--Indights:
--Bangalore is the cuty where Biriyani is most popular cuisine with 614 resturants.
-----------------------------------------------------------------
